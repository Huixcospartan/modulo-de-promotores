...
DATABASES = {
    'default': {
        ...
        'NAME': 'wana',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'wanagow',
        'PASSWORD': 'Wanagow123',
        'HOST': 'db4free.net',                      # cEmpty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
